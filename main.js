...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6287898307350@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE PROGAM BOT JANGAN LUPA SAVE ADI, PASTI DI SAVEBACK' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = 'HALO @user 👋\n SELAMAT DATANG DI  @subject \n❋Svb Admin❋\n-Svb Owner\n-𝟸𝟺𝙹𝚊𝚖 𝚋𝚘𝚝 𝚊𝚔𝚝𝚒𝚏\nDonasi Banh\n𝙼𝚒𝚗𝚊𝚝 ? wa.me/6285707042602' 
  conn.bye = 'TITIP MAKANAN BANH @user TELAH KELUAR DARI @subject'
